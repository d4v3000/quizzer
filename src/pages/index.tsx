...
const Home: NextPage = () => {
  ...
  return (
    <>
      <NavBar />
      <main className="mx-auto flex h-screen w-full flex-col items-center justify-start p-4 pt-20 sm:w-5/6 md:p-0 md:pt-20 xl:w-3/5">
        <div className="flex flex-col items-center gap-10">
          ...
          <p className="text-center text-3xl font-semibold text-gray-300">
            The free multiplayer quiz game where you can be your own quiz master
            and challenge your friends!
          </p>
          <div className="w-full xl:w-3/5">
            <Label text="Enter invitation code" />

            <form onSubmit={handleSubmit(onSubmit)} className="flex gap-2 pt-2">
              <Input
